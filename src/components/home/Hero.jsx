...
const Hero = () => {
  ...
  after:bg-gradient-to-r after:from-green-500 after:via-cyan-500 after:to-blue-500
    ...
    hover:after:scale-x-100"
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="hidden md:block px-6 py-2 bg-green-500 hover:bg-indigo-700 active:scale-95 transition-all rounded-full text-white"
              hidden={user}
            >
              Get started
            </Link>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          {/* Headline + CTA */}
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-17 md:leading-[70px]">
          ...
          <p className="max-w-md text-center text-base my-7">
            Start from scratch, upload your current resume, or select from
            modern templates — all ATS-optimized and powered by AI to help you
            edit and download job-ready resumes with ease.
          </p>
