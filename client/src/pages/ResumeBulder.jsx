...
import ProfissonalSummary from '../components/ProfissonalSummary'
...
const LoadExestingresume=async()=>{
  try {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
                ...
                <hr
                  className="absolute top-0 left-0  h-1 bg-gradient-to-r from-green-400 to-blue-800 rounded-full border-none transition-all duration-1500"
                  style={{
                ...
                <div className="flex justify-between items-center mb-6 border-b border-gray-200 py-1">
                  <div className="flex items-center gap-2">
                    <TemplateSelecter
                      ...
                      onChange={(template) =>
                        setResumeData((pri) => ({ ...pri, template }))
                      }
                    />
                    <ColorPicker
                ...
                <button
                  ...
                  className="bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 ring  rounded-md px-6 py-2 mt-6 text-sm hover:ring-green-500 transition-all duration-75 hover:size-[1.3] ease-in-out"
                >
                  Save Changes
                </button>
              </div>
